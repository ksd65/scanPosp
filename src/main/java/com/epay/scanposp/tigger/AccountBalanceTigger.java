		...
		/*	AccountExample accountExample = new AccountExample();
			...
			*/
			...
			if(memberList!=null && memberList.size()>0){
				...
				routeCode = RouteCodeConstant.TLH5_ROUTE_CODE;
				for(MemberInfo member:memberList){
					Integer memberId = member.getId();
				    RoutewayAccountExample routewayAccountExample = new RoutewayAccountExample();
					routewayAccountExample.createCriteria().andMemberIdEqualTo(memberId).andRouteCodeEqualTo(routeCode).andDelFlagEqualTo("0");
				...
				routeCode = RouteCodeConstant.TLWD_ROUTE_CODE;
				for(MemberInfo member:memberList){
					Integer memberId = member.getId();
				    RoutewayAccountExample routewayAccountExample = new RoutewayAccountExample();
					routewayAccountExample.createCriteria().andMemberIdEqualTo(memberId).andRouteCodeEqualTo(routeCode).andDelFlagEqualTo("0");
				...
				routeCode = RouteCodeConstant.ESKKJ_ROUTE_CODE;
				for(MemberInfo member:memberList){
					Integer memberId = member.getId();
				    RoutewayAccountExample routewayAccountExample = new RoutewayAccountExample();
					routewayAccountExample.createCriteria().andMemberIdEqualTo(memberId).andRouteCodeEqualTo(routeCode).andDelFlagEqualTo("0");
				...
				routeCode = RouteCodeConstant.ESKWGD0_ROUTE_CODE;
				for(MemberInfo member:memberList){
					Integer memberId = member.getId();
				    RoutewayAccountExample routewayAccountExample = new RoutewayAccountExample();
					routewayAccountExample.createCriteria().andMemberIdEqualTo(memberId).andRouteCodeEqualTo(routeCode).andDelFlagEqualTo("0");
				...
				routeCode = RouteCodeConstant.TLKJ_ROUTE_CODE;
				for(MemberInfo member:memberList){
					Integer memberId = member.getId();
				    RoutewayAccountExample routewayAccountExample = new RoutewayAccountExample();
					routewayAccountExample.createCriteria().andMemberIdEqualTo(memberId).andRouteCodeEqualTo(routeCode).andDelFlagEqualTo("0");
					...
					Double tradeMoneyBalance = commonService.countMemberProfitMoneyByCondition(paramMap);
					tradeMoneyBalance = tradeMoneyBalance == null ? 0 : tradeMoneyBalance;//昨天交易账户余额
