...
public class RSAUtil {  
    ...
    public static void main(String[] args) throws Exception {
    	...
    	//睿卡通
    	//String url = "jdbc:mysql://192.168.11.2:3306/epay?useUnicode=true&characterEncoding=UTF-8&useSSL=false";
    	//String username ="epay";
    	//String password = "Yidian@123";
    	//骏狐
    	String url = "jdbc:mysql://rm-bp10rs4swdoz51ye1o.mysql.rds.aliyuncs.com/johu?useUnicode=true&characterEncoding=UTF-8&useSSL=false";
    	String username ="johu";
    	String password = "johu@0601";
    	...
    	String id="9b47f178a9874c1b9da6dffad701fd0c";//对应机构id，修改这里运行main方法
		String sql = "UPDATE sys_office set private_key_rsa='"+privateKeyStr+"',public_key_rsa='"+publicKeyStr+"' where id='"+id+"'";
